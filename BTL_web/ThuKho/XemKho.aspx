<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="XemKho.aspx.cs" Inherits="BTL_web.XemKho" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container">
            <h2>Kho:
                <asp:Label ID="lblTenKho" runat="server" Text="Kho Hàng Hóa" Font-Bold="true"></asp:Label>
            </h2>
