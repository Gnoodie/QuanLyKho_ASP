<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TrangThuKho.aspx.cs" Inherits="BTL_web.TrangThuKho" %>
...
<head runat="server">
    ...
    <style>
        ...
        .dialog-footer {
            display: flex;
            justify-content: space-between; /* Dồn hai nút về hai phía */
            padding-top: 10px;
        }

        .btn-cancel {
            margin-left: auto; /* Đẩy nút Hủy về bên phải */
